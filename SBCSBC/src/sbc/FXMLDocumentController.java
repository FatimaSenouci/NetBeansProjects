...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML
    private TableColumn<RegleModel, String> idDeclanche;
    @FXML
    private Button idrecherche;
    @FXML
    private JFXTextField idBut;
 ...
 new faitModel("Hello")
   ...
   ObservableList<RegleModel> regles = FXCollections.observableArrayList(
    ...
    private void OnSearche(ActionEvent event) {
//        idBut.textProperty().addListener(new InvalidationListener() {
//            @Override
//            public void invalidated(Observable observable) {
//                if (idBut.textProperty().get().isEmpty()) {
//                    idTable.setItems(regles);
//                    return;
//                }
//                ObservableList<RegleModel> items = FXCollections.observableArrayList();
//                ObservableList<TableColumn<RegleModel, ?>> column = idTable.getColumns();
//
//                for (int row = 0; row < regles.size(); row++) {
//                    for (int col = 0; col < column.size(); col++) {
//                        TableColumn tabVar = column.get(col);
//                        String cellData = tabVar.getCellData(regles.get(row)).toString();
//                        cellData = cellData.toLowerCase();
//
//                        if (cellData.contains(idBut.getText().toLowerCase()) && cellData.startsWith(idBut.getText().toLowerCase())) {
//                            items.add(regles.get(row));
//                            break;
//                        }
//                    }
//
//                }
//                idTable.setItems(items);
//            /*TableGuiché*/       }
//        });
//        
