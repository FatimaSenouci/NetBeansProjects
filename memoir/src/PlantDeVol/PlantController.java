...
//            ((Stage)PanePlan.getScene().getWindow()).setScene(new Scene(pane));
    ...
    id66.setText(id6.getValue().toString());
        String Text_1 = id1.getText();
        String Text_3 = id3.getText();
        String Text_2 = id2.getText();
        String Text_4 = id4.getText();
        String Text_5 = id5.getText();
      String Text_6 = id66.getText();
        String Text_7 = id7.getText();
        FXMLLoader Loader = new FXMLLoader();
        ...
        strip1.setText(Text_1, Text_3, Text_2, Text_4, Text_5, Text_6, Text_7);
        Parent p =Loader.getRoot();
        Stage stage = new Stage();
        stage.setScene(new Scene(p));
        stage.showAndWait();
...
//        String Text_7 = id7.getText();
        ...
        strip2.setText(Text_1, Text_3, Text_2, Text_4, Text_5, Text_6);
        Parent p =Loader.getRoot();
        Stage stage = new Stage();
        stage.setScene(new Scene(p));
        stage.showAndWait();
