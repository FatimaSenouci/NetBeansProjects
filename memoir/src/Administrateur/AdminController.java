...
//    }
        @FXML
    void Goreserve(MouseEvent event) throws IOException {
         AnchorPane pane =FXMLLoader.load(getClass().getResource("/Administrateur/reservation1.fxml"));
    ((Stage)enterPane.getScene().getWindow()).setScene(new Scene(pane));

    }

    @FXML
    private void goBillet(MouseEvent event) throws IOException {
           AnchorPane pane =FXMLLoader.load(getClass().getResource("/Administrateur/GuicherByer.fxml"));
    ((Stage)enterPane.getScene().getWindow()).setScene(new Scene(pane));
    }
