    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try{
            ...
            while(rs.next()){
                ...
                strips.add(new Stripmodel(rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7)));
            }
//            con.close();
...
////    }
    ...
    public void setText(String id1,String id2,String id3,String id4,String id5,String id6,String id7){
