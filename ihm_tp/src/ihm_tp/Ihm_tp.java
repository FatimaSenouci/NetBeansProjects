...
public class Ihm_tp extends JFrame implements ActionListener , DocumentListener,ItemListener  {
...
//TODO ***************************déclaration******************************************
 ...
 //****************************constructeur*****************************************       
	...
	//TODO Action Listener pour JButton 
	@Override
	...
	public void itemStateChanged(ItemEvent e) {
        if(ScaneTextField() &  ScaneJcheckBox()){  
       ...
       if(ScanJTFPannuler() ||  ScanJCHBPannuler()) { annuler.setEnabled(true);}
