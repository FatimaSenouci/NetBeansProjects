...
void setText(String flightid, String planeid,String lblDate2) {
    ...
    private void Go22(MouseEvent event) throws IOException {
           AnchorPane pane =FXMLLoader.load(getClass().getResource("Hangar.fxml"));
            ((Stage)root1.getScene().getWindow()).setScene(new Scene(pane));
    ...
    private void toDisplay(ActionEvent event) {
        ...
        Loader.setLocation(getClass().getResource("Hangar.fxml"));
        try{
            Loader.load();
